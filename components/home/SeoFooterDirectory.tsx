  ...
  return (
    <section className="mt-16 sm:mt-24 border-t border-zinc-800/80 pt-12 space-y-12 text-zinc-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono font-bold text-sky-400 uppercase tracking-wider">Cron Schedules</span>
            <ArrowRight className="w-3.5 h-3.5 text-sky-400 group-hover:translate-x-1 transition-transform" />
          </div>
          <p className="text-xs text-zinc-400">
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono font-bold text-emerald-400 uppercase tracking-wider">SQL Recipes</span>
            <ArrowRight className="w-3.5 h-3.5 text-emerald-400 group-hover:translate-x-1 transition-transform" />
          </div>
          <p className="text-xs text-zinc-400">
            Find duplicates, zero-downtime concurrent indexes, upserts (ON CONFLICT), running totals &amp; EXPLAIN ANALYZE.
          </p>
          <span className="text-[11px] font-mono text-emerald-500 font-semibold">Browse 10+ SQL Guides &rarr;</span>
        </Link>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono font-bold text-indigo-400 uppercase tracking-wider">Device Viewports</span>
            <ArrowRight className="w-3.5 h-3.5 text-indigo-400 group-hover:translate-x-1 transition-transform" />
          </div>
          <p className="text-xs text-zinc-400">
            CSS dimensions, DPR scaling, screen resolutions, Tailwind breakpoints &amp; media queries for 22+ devices.
          </p>
          <span className="text-[11px] font-mono text-indigo-500 font-semibold">Browse 22+ Viewports &rarr;</span>
        </Link>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono font-bold text-sky-400 uppercase tracking-wider">Kubernetes Recipes</span>
            <ArrowRight className="w-3.5 h-3.5 text-sky-400 group-hover:translate-x-1 transition-transform" />
          </div>
          <p className="text-xs text-zinc-400">
            Port-forwarding, container exec bash, CrashLoopBackOff fixes, rolling restarts &amp; safe node draining.
          </p>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono font-bold text-emerald-400 uppercase tracking-wider">Nginx Recipes Hub</span>
            <ArrowRight className="w-3.5 h-3.5 text-emerald-400 group-hover:translate-x-1 transition-transform" />
          </div>
          <p className="text-xs text-zinc-400">
            Reverse proxy, SSL HTTPS redirect, SPA try_files, rate limiting, CORS &amp; WebSockets.
          </p>
          <span className="text-[11px] font-mono text-emerald-500 font-semibold">Browse 9+ Nginx Boilerplates &rarr;</span>
        </Link>
      </div>
