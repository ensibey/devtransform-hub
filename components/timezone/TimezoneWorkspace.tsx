    ...
    <div className="space-y-6">
      ...
      <div className="p-6 rounded-2xl bg-white dark:bg-zinc-900/60 border border-slate-200 dark:border-zinc-800 space-y-6 shadow-sm">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 p-4 rounded-xl bg-slate-50 dark:bg-zinc-950/60 border border-slate-200 dark:border-zinc-800/80 text-xs">
          ...
          {/* Calendar Action Buttons (Mobile-friendly min-h 44px tap targets) */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full md:w-auto">
            <a
              href={googleCalendarUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="min-h-[44px] inline-flex items-center justify-center space-x-2 px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 active:scale-[0.98] text-white font-semibold transition-all shadow-sm text-xs"
            >
            ...
            <button
              ...
              className="min-h-[44px] inline-flex items-center justify-center space-x-2 px-4 py-2.5 rounded-xl bg-slate-200 dark:bg-zinc-800 hover:bg-slate-300 dark:hover:bg-zinc-700 active:scale-[0.98] text-slate-800 dark:text-zinc-200 font-semibold border border-slate-300 dark:border-zinc-700 transition-all shadow-sm text-xs"
            >
              {icsCopied ? (
                <>
