...
import { GitRecipe } from '@/lib/git-recipes-data';
...
interface GitCommandBuilderProps {
  recipe: GitRecipe;
}

export function GitCommandBuilder({ recipe }: GitCommandBuilderProps) {
  const getRiskBadge = () => {
