        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1.5">
              ...
              <li>
                <Link href="/viewport/directory/" className="text-emerald-600 dark:text-brand-emerald font-semibold hover:underline">
                  📱 Device Viewports &amp; Screen Resolutions
                </Link>
              </li>
              <li>
                <Link href="/k8s/directory/" className="text-emerald-600 dark:text-brand-emerald font-semibold hover:underline">
                  ☸️ Kubernetes kubectl Recipes
                </Link>
              </li>
              <li>
                <Link href="/openssl/directory/" className="text-emerald-600 dark:text-brand-emerald font-semibold hover:underline">
                  🔐 OpenSSL Command Cheatsheet
                </Link>
              </li>
              <li>
                <Link href="/systemd/directory/" className="text-emerald-600 dark:text-brand-emerald font-semibold hover:underline">
                  ⚙️ Systemd Service Generator
                </Link>
              </li>
              <li>
                <Link href="/gitignore/directory/" className="text-emerald-600 dark:text-brand-emerald font-semibold hover:underline">
                  🙈 .gitignore Templates Directory
                </Link>
              </li>
              <li>
                <Link href="/nginx/directory/" className="text-emerald-600 dark:text-brand-emerald font-semibold hover:underline">
                  🌐 Nginx Config &amp; Recipes Hub
                </Link>
              </li>
              <li>
