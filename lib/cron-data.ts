...
export const CRON_SCHEDULES: CronScheduleInfo[] = [
  ...
  },
  {
    ...
    expression: '0 9 * * 1-5',
    title: 'Every Weekday at 9:00 AM (0 9 * * 1-5)',
    titleTr: 'Hafta İçi Her Gün Sabah 09:00',
    description: 'Runs Monday through Friday at 09:00 AM (ideal for daily standup reminders and business alerts).',
    descriptionTr: 'Pazartesi\'den Cuma\'ya hafta içi her sabah saat 09:00\'da tetiklenir.',
    minute: '0',
    hour: '9',
    dayOfMonth: 'Every day (*)',
    month: 'Every month (*)',
  ...
  },
  {
    ...
    title: 'Every Day at Midnight (0 0 * * *)',
    titleTr: 'Her Gece Yarısı 00:00',
    description: 'Runs once daily at 00:00 midnight (ideal for database backups and log rotation).',
    descriptionTr: 'Her gece 00:00 saatinde günlük veri tabanı yedekleme ve temizlik için çalışır.',
    minute: '0',
    hour: '0',
    dayOfMonth: 'Every day (*)',
    month: 'Every month (*)',
  ...
  },
  {
    ...
    title: 'Every 2 Hours (0 */2 * * *)',
    titleTr: 'Her 2 Saatte Bir',
    description: 'Runs at the top of the hour every 2 hours (00:00, 02:00, 04:00, 06:00, etc.).',
    descriptionTr: 'Günün her 2 saatinde bir saat başında çalışır.',
    minute: '0',
