...
export const CRON_SCHEDULES: CronScheduleInfo[] = [
  ...
  },
  {
    ...
    title: 'Every 2 Hours (0 */2 * * *)',
    titleTr: 'Her 2 Saatte Bir',
    description: 'Runs at minute 0 of every second hour (00:00, 02:00, 04:00, etc.).',
    descriptionTr: 'Günün her 2 saatinde bir tam saat başında tetiklenir.',
    minute: '0',
    hour: 'Every 2 hours (*/2)',
    dayOfMonth: 'Every day (*)',
    month: 'Every month (*)',
    dayOfWeek: 'Every day (*)',
    category: 'hourly',
  },
  {
    ...
    expression: '0 */6 * * *',
    title: 'Every 6 Hours (0 */6 * * *)',
    titleTr: 'Her 6 Saatte Bir',
    description: 'Runs at 00:00, 06:00, 12:00, and 18:00 every day (ideal for periodic data cache synchronization).',
    descriptionTr: 'Günde 4 kez 6 saatlik periyotlarla tam saat başında çalışır.',
    minute: '0',
    hour: 'Every 6 hours (*/6)',
    dayOfMonth: 'Every day (*)',
    month: 'Every month (*)',
    dayOfWeek: 'Every day (*)',
    category: 'hourly',
  ...
  },
  {
    ...
    description: 'Runs Monday through Friday at 09:00 AM sharp (ideal for morning daily standup summaries and morning report emails).',
  ...
  },
  {
    ...
    description: 'Runs at 00:00 every Saturday night (ideal for weekly batch migrations and archiving logs).',
    descriptionTr: 'Her Cumartesi gecesi tam 00:00\'da çalışır.',
    minute: '0',
    hour: '0',
    dayOfMonth: 'Every day (*)',
    month: 'Every month (*)',
  ...
  },
  {
    ...
    description: 'Runs annually at midnight on January 1st (ideal for annual tax year rollover and fiscal year reset tasks).',
