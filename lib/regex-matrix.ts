...
export const REGEX_PATTERNS: RegexDefinition[] = [
  ...
  {
    slug: 'slug-url-regex',
    title: 'URL Friendly Slug (kebab-case) Regex',
    category: 'formatting',
    pattern: '^[a-z0-9]+(?:-[a-z0-9]+)*$',
    flags: '',
    description: 'Validates clean URL slugs containing lowercase letters, numbers, and single hyphens.',
    sampleMatch: 'nextjs-14-complete-developer-guide',
    sampleFail: 'Invalid Slug--Title!',
    explanation: [
      '^[a-z0-9]+ : Starts with lowercase alphanumeric char',
      '(?:-[a-z0-9]+)*$ : Allows hyphen-separated alphanumeric segments without double hyphens',
    ],
  },
  {
  ...
  {
    slug: 'uuid-v4-validation-regex',
    title: 'Canonical UUID v4 Validation Regex',
    category: 'validation',
    pattern: '^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$',
    flags: '',
    description: 'Validates strict RFC 4122 Version 4 UUIDs with 4 in version position and 8, 9, a, or b in variant position.',
    sampleMatch: 'c81d4e2e-bcf2-41e6-869b-7df92533c26e',
    sampleFail: 'c81d4e2e-bcf2-11e6-869b-7df92533c26e',
    explanation: [
      '-4[0-9a-fA-F]{3}- : Version 4 marker',
      '-[89abAB][0-9a-fA-F]{3}- : RFC 4122 variant bits',
    ],
  },
];
