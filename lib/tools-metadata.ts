import { ToolMetadata, ToolCategory, CATEGORIES } from '@/types/tool';
...
export function getToolMetaBySlug(slug: string): ToolMetadata | undefined {
  return TOOLS_METADATA.find((t) => t.slug === slug);
}

export function getToolsMetaByCategory(category: ToolCategory): ToolMetadata[] {
  return TOOLS_METADATA.filter((t) => t.category === category);
}

export function getPopularToolsMeta(): ToolMetadata[] {
  return TOOLS_METADATA.filter((t) => t.isPopular);
}
